...
from hwsnn.abstract_rsnn import CHECKPOINT_PATH
import time 
...
def train(snn, data, learning_rate, num_epochs, spkreg = 0.0, l1_reg=0.0, dropout = 0.0, lr_scale = (2.0, 5.0), ckpt_dir = 'checkpoint', test_fn=None, scheduler=(1, 0.98), verbose=True):
    ...
    for epoch in range(num_epochs):
        ...
        snn.train_step(train_loader, optimizer=optimizer, spkreg=spkreg, l1_reg=l1_reg, dropout=dropout, verbose=verbose)
        if verbose:
